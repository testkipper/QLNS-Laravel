...
<p class="mt-0">.</p>
<p class="mt-0">.</p>
<h4 class="mttb">Quản lý phân công</h4>
                <ol class="breadcrumb mb-4 mtt">
                    <li class="breadcrumb-item "><a href="">admin</a></li>
                    <li class="breadcrumb-item active">quanly-phancong</li>
                </ol>
...
<div class="row">
    ...
    <thead>
       <tr>
            ...
            <th class="col-lg-1">Số giờ làm việc</th>
            <th class="col-lg-2">Tiến trình làm việc</th>
            <th class="col-lg-2">Công việc được giao</th>
    ...
    <div class="modal-content">
      ...
      <form>
        <div class ="form-row" >
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Công việc được giao</label>
          ...
          <div class="form-group">
            <label for="exampleInputPassword1">Số giờ làm việc</label>
